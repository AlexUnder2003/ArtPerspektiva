      ...
      <div className="w-full mx-auto px-4 py-4" id="top">
        ...
        <div className="mt-12">
          <div className="flex items-center justify-between mb-4">
            ...
            <Button variant="solid" onClick={() => navigate("/")}>Посмотреть все</Button>
          </div>
        ...
        {isFullscreen && (
          <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50" onClick={handleClose}>
            ...
            <img src={painting.image} alt={`${painting.title} - полный экран`} className="max-w-[100vw] max-h-[100vh] object-contain" />
          </div>
        )}
      </div>
    </DefaultLayout>
